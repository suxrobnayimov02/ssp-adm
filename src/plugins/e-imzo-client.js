...
String.prototype.splitKeep = function (splitter, ahead) {
  ...
  if (splitter != "") {
    ...
    var r = self[replaceName](splitter, (m, i, e) => {
...
var EIMZOClient = {
  NEW_API: false,
  // API_KEYS:[
  // 	"appt.netdoc.uz","324AFCB918E1112972B73D372F39CA42B0767FA3F1DC8F49B067FC8BAB98BB22ADC3A78B10C5574E1AF49F3178680A2A643F060D27B04598B876FEAE235342AF",
  // 	"app.netdoc.uz", "C30D0890FF39A0C17B68A71947AE6A8B321A02D2209310A33D08DE6DC38A7AF702DAA433CB3BEC689F5745586FF7F3E83F63B4BCE523F6D05F9C53B733B2E414",
  ...
  createPkcs7: function (id, data, success) {
    CAPIWS.callFunction(
      {
        plugin: "pkcs7",
        name: "create_pkcs7",
  ...
  appendPkcs7Attached: function (id, data, success) {
    CAPIWS.callFunction(
