      ...
      <div class="m-2">
         <b-row>
            ...
            >
               ...
               <b-button variant="primary" :to="{ name: 'EditNews',params : {id : 0}}">
      ...
      >
         ...
         <template #cell(actions)="{item}">
            <div class="text-center">
               ...
               <b-link
                  v-if="$can('NewsDelete', 'permissions')"
...
export default {
   ...
   methods: {
      DbClick(item) {
         this.$router.push({ name: 'EditNews', params: { id: item.id } });
      },
      SortChange(data) {
      ...
      Refresh() {
         this.isBusy = true;
         NewsService.GetList(this.filter).then(res => {
