  ...
  <b-card no-body>
    <div class="m-2">
      <b-row>
        ...
        >
          ...
          />
          <!-- <b-button variant="primary" :to="{ name: 'EditCountry', params: { id: 0 } }">
    ...
    >
      ...
      <template #cell(actions)="{ item }">
        <b-link
          :to="{ name: 'ViewContractor', params: { id: item.id } }"
...
export default {
  ...
  methods: {
    ...
    Refresh() {
      this.isBusy = true;
      ContractorService.GetList(this.filter).then(res => {
