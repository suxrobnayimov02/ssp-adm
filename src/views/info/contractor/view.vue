   ...
   <div>
      <b-card>
         <b-row>
            ...
            <b-col sm="12" md="3">
               <div class="form-group">
                  <form-input v-model="Data.country" :label="$t('Country')" :disabled="disabled" />
               </div>
            </b-col>

            <b-col sm="12" md="3">
               <div class="form-group">
                  <form-input v-model="Data.region" :label="$t('region')" :disabled="disabled" />
               </div>
            </b-col>

            <b-col sm="12" md="3">
               <div class="form-group">
                  <form-input v-model="Data.district" :label="$t('Region')" :disabled="disabled" />
               </div>
            </b-col>

            <b-col sm="12" md="3">
               <div class="form-group">
                  <form-input v-model="Data.address" :label="$t('address')" :disabled="disabled" />
               </div>
            </b-col>

            <b-col sm="12" md="3">
               <div class="form-group">
                  <form-input v-model="Data.director" :label="$t('director')" :disabled="disabled" />
               </div>
            </b-col>
            ...
            <b-col sm="12" md="3">
               <div class="form-group">
                  <form-input v-model="Data.oked" :label="$t('Oked')" :disabled="disabled" />
               </div>
            </b-col>
         </b-row>
         <b-row class="mt-3">
            ...
            <b-col sm="12" md="6" lg="6" class="text-right">
               <b-button @click="SaveData" size="sm" variant="outline-success" :disabled="disabled">
...
export default {
   ...
   methods: {
      ...
      SaveData() {
         ...
         if (this.checkValid()) {
            ContractorService.Update(this.Data)
               .then(res => {
