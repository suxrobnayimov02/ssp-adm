            ...
            <b-row>
               <b-col sm="12" md="3">
                  <div class="form-group">
                     <form-input v-model="Data.orderCode" rules="required" :label="$t('code')" />
                  </div>
               </b-col>

               <b-col sm="12" md="3">
                  <div class="form-group">
                     <form-input v-model="Data.number" rules="required" :label="$t('number')" />
                  </div>
               </b-col>
               ...
               <b-col sm="12" md="3">
                  <div class="form-group">
                     <form-input v-model="Data.theme" rules="required" :label="$t('theme')" />
                  </div>
               </b-col>

               <b-col sm="12" md="3">
                  <div class="form-group">
                     <form-input v-model="Data.tag" rules="required" :label="$t('tag')" />
                  </div>
               </b-col>

               <b-col sm="12" md="3">
                  <div class="form-group">
                     <form-input v-model="Data.uri" rules="required" :label="$t('uri')" />
                  </div>
               </b-col>
            </b-row>
            <b-row class="mt-3">
...
import VideoCLessonService from '@/services/info/videolesson.service';
...
export default {
   ...
   created() {
      ...
      VideoCLessonService.Get(this.$route.params.id).then(res => {
         this.Data = res.data;
      });
      ...
      VideoCategoryService.GetAsSelectList()
         .then(res => {
      ...
      SaveData() {
         this.$refs.ValidationDTO.validate().then(success => {
            if (success) {
               ...
               VideoCLessonService.Update(this.Data)
                  .then(res => {
