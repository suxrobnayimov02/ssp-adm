   ...
   <b-card no-body>
      <div class="m-2">
         <b-row>
            ...
            >
               ...
               />
               <b-button variant="primary" :to="{ name: 'EditDistrict', params: { id: 0 } }">
      ...
      >
         ...
         <template #cell(actions)="{ item }">
            <b-link
               :to="{ name: 'EditDistrict', params: { id: item.id } }"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         DistrictService.Delete(item.id)
            .then(res => {
      ...
      Refresh() {
         this.isBusy = true;
         DistrictService.GetList(this.filter).then(res => {
