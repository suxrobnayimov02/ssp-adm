      ...
      >
         ...
         <template #cell(actions)="{ item }">
            <div class="text-center">
               <b-link
                  v-if="$can('AppointEmployeeEdit', 'permissions')"
               ...
               <b-link v-if="$can('AppointEmployeeDelete', 'permissions')" class="text-danger" @click="$refs['DeleteModal' + item.id].show()" style="cursor: pointer" v-b-tooltip.hover.top="$t('Delete')">
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         AppointEmployeeService.Delete(item.id)
            .then((res) => {
      ...
      Refresh() {
         this.isBusy = true;
         AppointEmployeeService.GetList(this.filter).then((res) => {
...
@/services/hrm/appointemployee.service
