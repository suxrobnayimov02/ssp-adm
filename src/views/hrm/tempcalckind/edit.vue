      ...
      <b-modal size="xl" v-model="TabrowModal" no-close-on-backdrop hide-footer>
         <validation-observer ref="ValidationTabrow">
            <b-row align-v="center">
               <b-col sm="12" md="6">
                  <form-select :options="DepartmentList" v-model="tabrow.departmentId" :label="$t('Department')" />
               </b-col>
               <b-col sm="12" md="6" class="mb-1">
                  <EmployeeManageSelect v-model="tabrow.employeeManageId" :employee="tabrow.employee" :label="$t('employeeManage')" @update:data="onUpdateEmployeeManage" />
               </b-col>
               <b-col sm="12" md="6">
                  <form-picker v-model="tabrow.startOn" :label="$t('startdate')" required :placeholder="$t('startdate')"></form-picker>
               </b-col>
               <b-col sm="12" md="6">
                  <form-picker v-model="tabrow.endOn" :label="$t('enddate')" :placeholder="$t('enddate')"></form-picker>
               </b-col>
               <b-col sm="12" md="6">
               ...
               <b-col sm="12" md="6">
                  <form-input :disabled="tabrow.isWithOutPay" v-model="tabrow.addPayDays" :label="$t('addPayDays')" />
               </b-col>
               <b-col sm="12" md="6" class="mb-1">
                  <form-picker v-model="tabrow.forPeriodStartOn" :disabled="tabrow.isWithOutPay" :label="$t('forPeriodStartOn')" :placeholder="$t('forPeriodStartOn')"></form-picker>
               </b-col>
               <b-col sm="12" md="6" class="mb-1">
                  <form-picker v-model="tabrow.forPeriodEndOn" :disabled="tabrow.isWithOutPay" :label="$t('forPeriodEndOn')" :placeholder="$t('forPeriodEndOn')"></form-picker>
               </b-col>
               <b-col sm="12" md="12">
