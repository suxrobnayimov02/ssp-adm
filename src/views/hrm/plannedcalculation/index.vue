      ...
      <div class="m-2">
         <b-row>
            <b-col cols="12" md="6" class="d-flex align-items-center justify-content-start mb-1 mb-md-0">
               ...
               />
               <b-button variant="primary" :to="{ name: 'EditPlannedCalculation', params: { id: 0 } }">
      ...
      >
         ...
         <template #cell(actions)="{ item }">
            <div class="text-center">
               <b-link
                  v-if="$can('PlannedCalculationEdit', 'permissions')"
               ...
               <b-link v-if="$can('PlannedCalculationDelete', 'permissions')" @click="$refs['DeleteModal' + item.id].show()" style="cursor: pointer" v-b-tooltip.hover.top="$t('Delete')">
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         PlannedCalculationService.Delete(item.id)
            .then(() => {
      ...
      Refresh() {
         this.isBusy = true;
         PlannedCalculationService.GetList(this.filter).then((res) => {
