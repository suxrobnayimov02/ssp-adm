      ...
      <div class="m-2">
         <b-row>
            <b-col cols="12" md="6" class="d-flex align-items-center justify-content-start mb-1 mb-md-0">
               ...
               />
               <b-button variant="primary" :to="{ name: 'EditEmployeeLeaveOrder', params: { id: 0 } }">
      ...
      >
         ...
         <template #cell(actions)="{ item }">
            <div class="text-center">
               <b-link
                  v-if="$can('EmployeeLeaveOrderEdit', 'permissions')"
                  :to="{ name: 'EditEmployeeLeaveOrder', params: { id: item.id } }"
               ...
               <b-link
                  v-if="$can('EmployeeLeaveOrderDelete', 'permissions')"
...
export default {
   ...
   methods: {
      ...
      Delete(item) {
         ...
         EmployeeLeaveOrderService.Delete(item.id)
            .then((res) => {
      ...
      Refresh() {
         this.isBusy = true;
         EmployeeLeaveOrderService.GetList(this.filter).then((res) => {
...
@/services/hrm/EmployeeLeaveOrder.service
