  ...
  >
    ...
    <div class="customizer-section d-flex justify-content-between align-items-center">
      <div>
        ...
        <small>{{ $t('Customize &amp; Preview in Real Time') }} </small>
      </div>
      <feather-icon
        icon="XIcon"
        size="18"
    ...
    >
      ...
      <div class="customizer-section">
        ...
        <!-- Skin -->
        <b-form-group :label="$t('Content Width')">
          <b-form-radio-group
      ...
      <div class="customizer-section">
        ...
        >
          <span class="font-weight-bold"> {{ $t('Menu Collapsed') }} </span>
          <b-form-checkbox
        ...
        <div class="d-flex justify-content-between align-items-center mt-2">
          <span class="font-weight-bold"> {{ $t('Menu Hidden') }} </span>
          <b-form-checkbox
      ...
      <div class="customizer-section">
        ...
        <!-- Navbar Type -->
        <b-form-group :label="layoutType === 'vertical' ? $t('Navbar Type') : $t('Menu Type')">
          <b-form-radio-group
            v-model="navbarType"
            name="navbar-type"
            :options="navbarTypes"
      ...
      <div class="customizer-section">
        ...
        <!-- Footer Type -->
        <b-form-group :label="$t('Footer Type')">
          <b-form-radio-group
            v-model="footerType"
            name="footer-type"
            :options="footerTypes"
